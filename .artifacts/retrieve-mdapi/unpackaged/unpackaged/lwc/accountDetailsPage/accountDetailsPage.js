...
const ORDERS_URL = '/AmericanBookCompany/my-orders';
const PAYMENT_METHOD_URL = '/AmericanBookCompany/add-payment-methods';
const SUBMIT_PO_URL = '/AmericanBookCompany/submit-a-po';
const WISHLIST_URL = 'https://americanbookcompany.com/account/my-wishlist';
...
export default class AccountDetailsPage extends LightningElement {
    ...
    @api ordersUrl = ORDERS_URL;
    @api submitPoUrl = SUBMIT_PO_URL;
    @api wishlistUrl = WISHLIST_URL;
    ...
    get shippingStatusLabel() {
        return this.details?.hasShippingAddress ? 'Address on file' : 'Action needed';
    }
