...
const REPS_BY_STATE = {
  ...
  Arkansas: [
    ...
    { key: 'ar-danielle', name: 'Danielle Pintozzi', title: 'Arkansas Account Executive', phone: DEFAULT_PHONE, email: 'drpintozzi@americanbookcompany.com', imageBase: 'danielle-pintozzi' }
  ],
  ...
  Oklahoma: [
    { key: 'ok-michele', name: 'Michele Lantz', title: 'Senior Account Executive', phone: DEFAULT_PHONE, email: 'mlantz@americanbookcompany.com', imageBase: 'michele-lantz' }
  ],

  Indiana: [
    { key: 'in-laura', name: 'Laura Riffle', title: 'Indiana Account Executive', phone: DEFAULT_PHONE, email: 'lriffle@americanbookcompany.com', imageBase: 'laura-riffle' }
  ],

  Mississippi: [
    { key: 'ms-jenny', name: 'Jenny Gale', title: 'Senior Account Executive', phone: DEFAULT_PHONE, email: 'jgale@americanbookcompany.com', imageBase: 'jenny-gale' }
  ],

  Tennessee: [
    { key: 'tn-jenny', name: 'Jenny Gale', title: 'Senior Account Executive', phone: DEFAULT_PHONE, email: 'jgale@americanbookcompany.com', imageBase: 'jenny-gale' }
  ],

  'District of Columbia': [
    { key: 'dc-rodney', name: 'Rodney Adams', title: 'Senior Account Executive', phone: DEFAULT_PHONE, email: 'radams@americanbookcompany.com', imageBase: 'rodney-adams' }
  ],
