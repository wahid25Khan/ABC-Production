 ...
 */
export function openAuthPopup(host, url, popupName, { buildAuthUrl, onCompletion }) {
    ...
    if (popup && typeof popup.focus === 'function') {
        startAuthPopupMonitor(host, popup, onCompletion);
        popup.focus();
        return;
    }
 ...
 */
export function startAuthPopupMonitor(host, popup, onCompletion) {
