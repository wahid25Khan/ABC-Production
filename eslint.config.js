...
module.exports = defineConfig([
  ...
  {
    files: [
      "**/lwc/customResults/*.js",
      "**/lwc/similarProductsBySubject/*.js"
    ],
    rules: {
  ...
  // productRecommendation and productGrid use requestAnimationFrame for UI sync.
  {
    files: ["**/lwc/productRecommendation/*.js", "**/lwc/productGrid/*.js"],
    rules: {
      "@lwc/lwc/no-async-operation": "off"
    }
  },
  ...
  {
    files: ["**/lwc/stateCountyMapbox/*.js", "**/lwc/mapPlusTestimonial/*.js"],
    languageOptions: {
      globals: {
        mapboxgl: "readonly"
      }
  ...
  // stateFilterLwc intentionally patches Experience Cloud cart and checkout DOM.
  {
    files: ["**/lwc/stateFilterLwc/*.js"],
    rules: {
      "@lwc/lwc/no-document-query": "off",
  ...
  // stateReps and stateTestimonials poll URL/localStorage-driven state in Experience pages.
  {
    files: ["**/lwc/stateReps/*.js", "**/lwc/stateTestimonials/*.js"],
    rules: {
      "@lwc/lwc/no-async-operation": "off"
    }
  },
